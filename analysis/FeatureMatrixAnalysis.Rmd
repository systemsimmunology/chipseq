...
Filter on polII signal intensity. Stringent: maximum pol II signal intensity > 4, yields ```r length(s4.nm)``` RefSeqs; Moderate: maximum pol II signal intensity > 1, yields ```r length(s1.nm)`` RefSeqs 
...
First *compare against PolII signal clusters.*  
