...
load("~/chipseq/results/20120718/clusters.p2sigint.RData")
...
clabels.p2 <- c("Peak at 1hr","Peak at 2hr","Decreasing","Peak at 4hr")
...
cvsig <- sdsig/meansig
lowvars <- union(names(which(cvsig<0.1)),names(which(sdsig==0)))
